...
function visualmode() {
  ...
  document.querySelector('.parcours-heading-article').classList.toggle('heading-article-light');
  document.querySelector('.parcoursHeadingP').classList.toggle('heading-article-light');

  document.querySelector('.veille-heading-article').classList.toggle('heading-article-light');
  document.querySelector('.veilleHeadingP').classList.toggle('heading-article-light');

  document.querySelector('.synthese-heading-article').classList.toggle('heading-article-light');
  document.querySelector('.syntheseHeadingP').classList.toggle('heading-article-light');

  document.querySelector('.cv-heading-article').classList.toggle('heading-article-light');
  document.querySelector('.cvHeadingP').classList.toggle('heading-article-light');
  ...
  document.getElementById('PHP').classList.toggle('language-gradient-class');
...
function hamburgerMenu() {
  ...
  document.getElementById("burger-bar5").classList.toggle("hamburger-animation5");
  document.getElementById("burger-bar6").classList.toggle("hamburger-animation6");
  document.getElementById("burger-bar7").classList.toggle("hamburger-animation7");
}
...
function hidemenubyli() {
  ...
  document.getElementById("burger-bar5").classList.remove("hamburger-animation5");
  document.getElementById("burger-bar6").classList.remove("hamburger-animation6");
  document.getElementById("burger-bar7").classList.remove("hamburger-animation7");
}
...
console.log('%c Designed and Developed by senthalan THAYAPARAN ', 'background-image: linear-gradient(90deg,#8000ff,#6bc5f8); color: white;font-weight:900;font-size:1rem; padding:20px;');
